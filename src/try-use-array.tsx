...
export const TsReactTest = () => {
  ...
  const { value, setValue, clear, removeIndex, add } = useArray(persons);

  // console.log(value, '-------------11l-----------------')
  // console.log(setValue, '--------------12l-----------')
  // console.log(add, '-------------13l-----------------')
  ...
  return (
    <div>
      ...
      <button onClick={foox}>add johnx</button>
      {/* <button onClick={add}>add johns</button> */}
